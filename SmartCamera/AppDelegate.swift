...
class AppDelegate: UIResponder, UIApplicationDelegate, UNUserNotificationCenterDelegate, AVAudioPlayerDelegate {
    ...
    var window: UIWindow?
    var householdObjects: [String] = ["Computer", "Television", "Bed", "Shoes", "Person", "Towel", "Belt", "Comb", "Soap Dispenser", "Plant", "Faucet", "Socket", "Toilet", "Sweatshirt", "Watch", "Refrigerator", "Pair of Scissors", "Spoon", "Knife", "Microwave", "Mug", "Golf Ball", "Toilet Paper"]
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        if (UserDefaults.standard.value(forKey: "name") as? String) == nil {
            ...
            vc = storyboard.instantiateViewController(withIdentifier: "SettingsNavigationController")
            UserDefaults.standard.set(true, forKey: "coreDataIsEmpty")
            UserDefaults.standard.set(false, forKey: "alarmIsOn")
            UserDefaults.standard.set(false, forKey: "alarmIsSounding")
        } else {
    ...
    func userNotificationCenter(_ center: UNUserNotificationCenter, didReceive response: UNNotificationResponse, withCompletionHandler completionHandler: @escaping () -> Void) {
        if response.actionIdentifier == "OpenApp" {
            playSound("alarm")
            UserDefaults.standard.set(true, forKey: "alarmIsSounding")
            self.window = UIWindow(frame: UIScreen.main.bounds)
            let storyboard = UIStoryboard(name: "Main", bundle: nil)
